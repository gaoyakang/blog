...
- The key to brush control lies in the “edge” (锋), but no one explains what it is. In my view, the edge is the surface generated by the movement of a line formed by aligned brush hairs — that is, a line moving forms a surface. By varying direction, pressure, and speed, you can control different lines and produce different edges.It is far from enough to know what a "feng" (a traditional Chinese term referring to the direction of a brush) is. The important thing is to understand how to adjust the "feng". The essence of adjusting the "feng" is to adjust the direction of the line formed by the brush tufts in the same direction. When this line points to different points on the 12-point clock, it is called
  For different types of feng, the center feng line is perpendicular to the 39 connection line, while the side feng line is parallel to the 104-115 connection line. The derivatives such as inverse feng, hidden feng, and leaking feng are different manifestations of feng. Transitioning from one type of feng to another relies on different hand movements
- The key to structure lies in beauty. Through brush control, you can produce strokes of varying length, thickness, size, density, and shade, but how to combine them to create beauty? No one mentions what beauty really is. In my view, beauty is a style: symmetry and order is a kind of beauty; roundness and ease is a kind; sharpness and decisiveness is another. Different people have different understandings and perceptions of beauty. Once you find a beauty that resonates with you, you have grasped the essence of structure.In the current Level 1 Character List of 3500 Commonly Used Chinese Characters, there are eight basic structures: independent structure, top-bottom structure, left-right structure, triangle structure, semi-enclosed structure, left-middle-right structure, top-middle-bottom structure, and fully enclosed structure
