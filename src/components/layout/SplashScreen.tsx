  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-[var(--bg-primary)]">
      ...
      >
        ...
        <path d="M 20 45 H 60" style={{strokeDasharray: "40", strokeDashoffset: "40", animation: "draw 0.1s ease 0.32s forwards"}} />
        <path d="M 60 45 V 65" style={{strokeDasharray: "20", strokeDashoffset: "20", animation: "draw 0.06s ease 0.42s forwards"}} />
        <path d="M 25 55 H 65" style={{strokeDasharray: "40", strokeDashoffset: "40", animation: "draw 0.1s ease 0.48s forwards"}} />
        <path d="M 20 65 H 60" style={{strokeDasharray: "40", strokeDashoffset: "40", animation: "draw 0.1s ease 0.58s forwards"}} />
